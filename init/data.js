const sampleListings = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1602088113235-229c19758e9f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8YmVhY2hsaWRheXxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=800&q=60",
      price: 1200,
      location: "Cotswolds",
  ...
  // Normalize image field to include both url and a sample filename
  const toSampleFilename = () => "sample.jpg";
  for (const listing of sampleListings) {
    if (typeof listing.image === "string") {
      listing.image = { url: listing.image, filename: toSampleFilename() };
    } else if (listing.image && typeof listing.image.url === "string") {
      listing.image.filename = listing.image.filename || toSampleFilename();
    }
  }
